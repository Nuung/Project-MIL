  ...
  _createClass(LoadScene, [{
    ...
    value: function preload() {
      ...
      this.load.on("complete", function () {
        ...
        progressBox.destroy();
        loadingText.destroy();
        percentText.destroy(); //this.scene.start(CST.SCENES.MENU, "hello from LoadScene");
      });
    }
  }, {
    key: "create",
...
function (_Phaser$Scene) {
  ...
  _createClass(MenuScene, [{
    ...
    value: function create() {
      ...
      var OptionButton = this.add.image(this.game.renderer.width / 2, this.game.renderer.height / 2 + 100, "options_button").setDepth(1); //SPRITES

      var hoverSprite = this.add.sprite(100, 100, "cat");
      hoverSprite.setScale(2);
      hoverSprite.setVisible(false); //SOUND!
